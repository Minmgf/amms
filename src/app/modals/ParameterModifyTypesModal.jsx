...
const ParameterModifyTypesModal = ({ 
  isOpen, 
  onClose, 
  parameter,
  onSave 
  ...
  useEffect(() => {
    if (parameter) {
      setFormData({
        category: parameter.category || 'Maintenance Types',
        typeName: parameter.name || '',
        description: parameter.description || '',
        isActive: parameter.status === 'Active'
      });
    }
  }, [parameter]);
...
<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
  <div className="bg-white rounded-lg shadow-xl w-full max-w-xl max-h-[90vh] overflow-hidden">
    <div className="flex items-center justify-between px-8 py-6 border-b border-gray-200">
      <h2 className="text-xl font-semibold text-gray-900">Modify parameter</h2>
      <button
        onClick={onClose}
...
export default ParameterModifyTypesModal;