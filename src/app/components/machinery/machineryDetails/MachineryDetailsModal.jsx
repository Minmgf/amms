            ...
            <div className="modal-theme rounded-2xl shadow-xl w-full max-w-6xl overflow-y-auto max-h-[95vh] relative">
                ...
                <div className="hidden md:block p-6">
                    ...
                    <div className="flex justify-center border-b border-[#737373] mb-6">
                        {['general', 'tech', 'docs'].map((key, idx) => {
                            const labels = ['Ficha General', 'Especificaciones Técnicas', 'Documentos y Mantenimiento']
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="border rounded-xl p-4 border-secondary">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <Row label="Nombre" value={selectedMachine?.machinery_name} />
                                        <Row label="Marca" value={brandName} />
                                        <Row label="Modelo" value={modelName} />
                                        <Row label="Año fabricación" value={selectedMachine?.manufacturing_year} />
                                        ...
                                        <Row label="Subpartida arancelaria" value={selectedMachine?.tariff_subheading} />
                    ...
                    {activeTab === 'tech' && (
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="border rounded-xl p-4 border-[#E5E7EB]">
                                <h3 className="font-semibold text-lg mb-3">Capacidad y Rendimiento</h3>
                                <div className="flex flex-col gap-3">
                    ...
                    {activeTab === 'docs' && (
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="border rounded-xl p-4 border-[#E5E7EB]">
                                <h3 className="font-semibold text-lg mb-3">Mantenimiento Periódico</h3>
                                <ul className="flex flex-col gap-3">
                                    {[
                ...
                <div className="md:hidden bg-[#F0F0F0]">
                    <div className='px-4 bg-white'>
                        ...
                        <h3 className="text-xl font-semibold mb-3">Datos Técnicos Generales</h3>
                        <div className="rounded-xl overflow-hidden">
                            {[
                                ...
                                ['Subpartida arancelaria', selectedMachine?.tariff_subheading || '—'],
                    ...
                    <div className="mt-2 overflow-hidden">
                        ...
                        {accUsageOpen && (
                            <div className='bg-white'>
                                {[
                                    ['Fecha adquisición', formatDate?.(selectedMachine?.acquisition_date) || '—'],
                    ...
                    <div className="mt-2 overflow-hidden">
                        <button
                            ...
                            className="w-full flex items-center justify-between px-4 py-5 bg-white"
                        >
                            <span className="font-bold text-lg">Datos Técnicos Específicos</span>
                    ...
                    <div className="mt-2 overflow-hidden bg-white">
                        ...
                        <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200">
                            ...
                            <button className="px-3 py-1.5 rounded-md text-white bg-black text-sm">Ver</button>
                        </div>
                    </div>

                    {/* Periodic maintenance (lista tipo chips) */}
                    <div className="mt-3 bg-white p-4 md:p-0">
                        <div className="font-bold text-lg mb-4">Mantenimiento periódico</div>
                            ...
                            {[
                                ...
                                <div key={task} className="flex items-center justify-between bg-gray-100 rounded-full px-3 py-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button className="text-xs px-2 py-0.5 rounded-full bg-rose-200 text-rose-800">Eliminar</button>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <button className="mt-3 w-full rounded-md bg-gray-400/80 text-white py-2">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
