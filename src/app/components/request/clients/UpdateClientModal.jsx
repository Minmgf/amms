...
const UpdateClientModal = ({
  ...
  useEffect(() => {
    if (clientData && isOpen) {
      setValue("identificationNumber", clientData.identification_number || "");
      setValue("identificationType", clientData.identification_type || "");
      setValue("personType", clientData.person_type || "");
      setValue("fullName", clientData.full_name || "");
      setValue("lastName", clientData.last_name || "");
      setValue("email", clientData.email || "");
      setValue("phoneCode", clientData.phone_code || "+57");
      setValue("phoneNumber", clientData.phone_number || "");
    }
  }, [clientData, isOpen, setValue]);
  ...
  const handleFormSubmit = async (data) => {
    ...
    try {
      ...
      // const response = await updateClient(clientData.id, payload);
