#!/usr/bin/env python3
"""
Prueba la página de login con la ruta correcta
"""
...
def test_login_page():
    """Prueba la página de login con la ruta correcta"""
    print("Probando pagina de login con ruta corregida...")
    ...
    try:
        # Navegar a la página de login con la ruta correcta
        ...
        # Tomar screenshot
        driver.save_screenshot("login_corrected_debug.png")
        print("Screenshot guardado: login_corrected_debug.png")
...
def main():
    """Función principal"""
    print("PRUEBA DE LOGIN CON RUTA CORREGIDA")
    print("="*40)
